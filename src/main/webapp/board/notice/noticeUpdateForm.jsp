	  ...
	  <h3 style="margin-top: -0.5em; margin-bottom: 1em;">공지사항 수정</h3>
		...
		<input type="hidden" name="boardId" value="${bdto.board_id }">
		  ...
		  <div class="mb-3">
			...
			<textarea class="form-control" rows="15" name="content" id="content"><c:out value="${bdto.board_content}"/></textarea>
		  </div>
					
		  <div>
			<input type="submit" value="수정하기" class="btn btn-sm btn-primary" id="btnSave">
