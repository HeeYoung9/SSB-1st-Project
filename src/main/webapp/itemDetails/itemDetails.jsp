...
<!------------ common CSS ------------->
<link rel="stylesheet" href="${pageContext.request.contextPath}/adItem/css/itemD.css">
...
<body>
    ...
    <section>
			...
			<form class="item_container" id="one">
				...
				<div class="first">
					<p class="title"> <img src="${pageContext.request.contextPath}/main/item_img/${itemDTO.item_img_logo}" alt="브랜드로고"> </p>
				...
				<div class="second">
					...
					<div id="fifth">
						<div class="rara">
							...
							<p class="name1"> ${itemDTO.item_name}_No.${itemDTO.item_id} </p> <br>
						</div>
						<div id="heart2">
					...
					<div class="detail2">
						...
						<span>
							<select class="options-select" name="" required>
