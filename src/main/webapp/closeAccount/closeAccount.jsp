	...
	<section class="section">
		<div id="withdrawalForm">
			...
			<form action="./MemberCloseAccountAction.me" id="reasonForm">
				<label for="withdrawalReason">탈퇴 사유:</label> <select
					id="withdrawalReason" name="withdrawalReason">
				...
				<button type="button" style="margin-left: 10%"
					onclick="location.href='./Main.in'">취소</button>
			</form>
		</div>
	</section>
	<!-- section 끝  -->
