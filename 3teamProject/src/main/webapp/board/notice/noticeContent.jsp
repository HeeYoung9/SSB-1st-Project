		  ...
		  <h3>공지사항 본문</h3>
			...
			<div style="margin-top : 20px">
				<button type="button" class="btn btn-sm btn-primary" id="btnUpdate"
						onclick="location.href='./NoticeUpdate.bo?boardId=${bdto.board_id }&pageNum=${pageNum }';">수정</button>
				<button type="button" class="btn btn-sm btn-primary" id="btnDelete"
						onclick="location.href='./NoticeDeleteAction.bo?boardId=${bdto.board_id }&pageNum=${pageNum }';">삭제</button>
				<button type="button" class="btn btn-sm btn-primary" id="btnList"
						onclick="location.href='./NoticeList.bo?pageNum=${pageNum }';">목록</button>
			</div>
	    </div>
	  </div>
	</article>	
