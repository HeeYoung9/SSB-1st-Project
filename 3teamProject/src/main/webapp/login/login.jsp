...
<body>
    ...
    <header class="header">
        <div class="logo">
            <img src="./templete/img/SSB_gold.png" style="width: 200px;">
        </div>
        <div>
    ...
    <div id="login_wrap">
        <div class="main-container">
            ...
            <div class="form-container" style="width: 380px;">
                ...
                <form action="loginProcess.lg" method="POST">
                ...
                <div class="info">
                    <span>
                        <button style="border: none; background-color: transparent; font-size: 12px; border: none;" onclick="window.open('./findID.fi' )">아이디 찾기</button>
                    </span>
                    <span>&nbsp;</span>
                    <span>
                ...
                <div class="d-grid gap-2" style="text-align: center;">
                    <a href="javascript:kakaoLogin();"><img src="./templete/img/kakao_login.png" alt="카카오계정 로그인" /></a>
                    ...
                    <a href="https://accounts.google.com/o/oauth2/v2/auth?c lient_id=253324653095-4p0h7jpcqct6512k21j23k72qkphd812.apps.googleusercontent.com&redirect_uri=./main.in&response_type=code&scope=openid%20email%20profile">
                        <img src="./templete/img/google_login.png" alt="구글 계정 로그인" /> <!-- 여기서 임시로 리다이렉트할 주소를 네이버로 해뒀습니다. 메인페이지 주소를 추후에 google developer에서 api 관리에 들어가서 수정할수 있습니다. -->
                    </a>
                    <a href="https://nid.naver.com/nidlogin.login?mode=form&url=https://www.naver.com/">
                        <img src="./templete/img/naver_login.png" alt="네이버 계정 로그인" />
                    </a>
                </div>
            </div>
        </div>
